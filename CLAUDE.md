...
5. **Ablauf in kindle_capture.py (Hotkey-basiert, neues WinUI-Kindle):**
   ...
   5. **Seitenformat von der Titelseite bestimmen** (`detect_page_region_from_cover`): Die letterboxte Titelseite hebt sich mit komplett schwarzem/weißem Rand vom Hintergrund ab. Erkannt wird ihr Rechteck über **Abdeckung + Rand-Test**, NICHT über Varianz:
